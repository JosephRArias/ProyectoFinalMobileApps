...
namespace ProyectoFinalMobile.Views
{
    ...
    public partial class ExplorePage : ContentPage
    {
		public static readonly BindableProperty CalculateCommandProperty =
		   BindableProperty.Create(nameof(CalculateCommand), typeof(ICommand), typeof(ExplorePage), null, BindingMode.TwoWay);
		...
		public static readonly BindableProperty UpdateCommandProperty =
		  BindableProperty.Create(nameof(UpdateCommand), typeof(ICommand), typeof(ExplorePage), null, BindingMode.TwoWay);
